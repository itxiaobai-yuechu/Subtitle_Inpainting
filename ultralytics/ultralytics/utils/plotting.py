    ...
    def box_label(
        ...
        if self.pil:
            ...
            if label:
                ...
                # print(
                #     f"The left-up angle's coordination: ({p1[0]}, {p1[1]})"
                # )  # 输出左上角坐标
                # print(
                #     f"The left-down angle's coordination: ({p1[0]}, {p2[1]})"
                # )  # 输出左下角坐标
                # print(
                #     f"The right-down angle's coordination: ({p2[0]}, {p2[1]})"
                # )  # 输出右下角坐标
                # print(
                #     f"The right-up angle's coordination: ({p2[0]}, {p1[1]})"
                # )  # 输出右上角坐标
